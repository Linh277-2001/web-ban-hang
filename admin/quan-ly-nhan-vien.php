            ...
            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><img class="img-card-person" src="<?php echo $row["anhthe"] ?>" alt=""></td>
                  ...
                  <td class="table-td-center">
                    <a onclick="return confirm('Xóa nhân viên này ra khỏi database.')" href="xoanhanvien.php?id=<?php echo $row["id"] ?>">
                    <button class="btn btn-primary btn-sm trash" type="button" title="Xóa">
                      <i class="fas fa-trash-alt"></i>
                    </button>
                    </a>
                    <a href="suanhanvien.php?id=<?php echo $row["id"] ?>">
