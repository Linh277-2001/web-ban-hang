    ...
    <div class="app-title">
      ...
      <form action="themnhanvien.php" method="POST" enctype="multipart/form-data">
          ...
          <fieldset class="form-group">
						...
						<input name="luong" id="luong" type="number" class="form-control" placeholder="Nhập lương" >
					</fieldset>
					...
					<button style="margin: 12px 260px" type="submit" id="add" class="btn btn-outline-primary">Thêm nhân viên</button>
				</form>
      </div>
