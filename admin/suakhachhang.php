...
<head>
  <title>Sửa khách hàng | Quản trị Admin</title>
  <meta charset="utf-8">
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    <div class="app-title">
      ...
      <?php
		$sql = "select * from user where idkhach='$id'";
		$result = $conn->query($sql);
		if ($result->num_rows > 0) {
		while ($row = $result->fetch_assoc()) {
            ?>
      <form action="xulysuakhachhang.php?id=<?php echo $row['idkhach'] ?>" method="POST" enctype="multipart/form-data">
					...
					<button style="margin: 12px 260px" type="submit" id="add" class="btn btn-outline-primary">Sửa khách hàng</button>
				</form>
                <?php
                   }
                 }
