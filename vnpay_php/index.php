    ...
    <body>
        ...
        <div class="container">
            <div class="header clearfix">
                <h3 style="font-weight:bold" align="center">THANH TOÁN ONLINE</h3>
            </div>
                ...
                <form action="vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="amount"
                               name="amount" type="number" value="<?php echo $price?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div style="font-weight:bold;display:none" class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_ship_fullname"
                               name="txt_ship_fullname" type="text" value="Nguyễn Văn Linh"/>
                    </div>
                    <div class="form-group">
                        <label >Email (*)</label>
                        <input class="form-control" id="txt_ship_email"
                               name="txt_ship_email" type="text" value="Linh@gmail.com"/>
                    </div>
                    <div class="form-group">
                        <label >Số điện thoại (*)</label>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_ship_addr1"
                               name="txt_ship_addr1" type="text" value="Học viện kỹ thuật Mật Mã, Chiến Thắng, Thanh Trì, Hà Nội"/>
                    </div>
                     <div style="font-weight:bold;display:none" class="form-group">
                        <label >Mã bưu điện (*)</label>
