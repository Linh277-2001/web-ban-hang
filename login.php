    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <!--=====TIÊU ĐỀ======-->
                <form class="login100-form validate-form" method="POST" action="xulilogin.php">
                    ...
                    <form action="">
                        ...
                        <button type="submit" class="btn btn-primary" name="login" style="margin-left: 32%">Đăng nhập</button>
