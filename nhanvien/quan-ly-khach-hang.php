        ...
        <div class="tile">
          <div class="tile-body">
            ...
            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
              ...
              <tbody>
              <?php
		            $sql = "select * from user order by idkhach asc";
              ...
              ?>
                <tr>
                  ...
                  <td class="table-td-center">
                    <a onclick="return confirm('Xóa khách hàng này ra khỏi database.')" href="xoakhachhang.php?id=<?php echo $row["idkhach"] ?>">
                      <button class="btn btn-primary btn-sm trash" type="button" title="Xóa">
                        <i class="fas fa-trash-alt"></i>
                      </button>
                    </a>
                    <a href="suakhachhang.php?id=<?php echo $row["idkhach"] ?>">
